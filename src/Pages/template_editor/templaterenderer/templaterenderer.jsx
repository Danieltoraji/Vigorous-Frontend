 ...
 */
function SceneContent({ template, onModelReady, hdrFile, smoothTexture = false }) {
...
function ModelRenderer({ template, onModelReady, hdrFile, smoothTexture = false }) {
    return (
        <div style={{ position: 'relative', width: '100%', height: '100%' }}>
            ...
            >
                <SceneContent template={template} onModelReady={onModelReady} hdrFile={hdrFile} smoothTexture={smoothTexture} />
            </Canvas>
